...
const handleLogout = async () => {
  ...
  return (
    <div className="relative min-h-screen bg-[#0a0a0a] text-zinc-300 font-sans selection:bg-indigo-500/30 overflow-hidden flex items-center justify-center p-6">
      ...
      <div className="absolute top-[10%] left-[20%] w-[40%] h-[40%] rounded-full bg-indigo-600/20 blur-[150px] pointer-events-none" />
      <div className="absolute bottom-[10%] right-[20%] w-[30%] h-[30%] rounded-full bg-purple-600/20 blur-[150px] pointer-events-none" />
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="bg-white/2 border border-white/5 p-8 sm:p-10 rounded-3xl backdrop-blur-xl shadow-2xl animate-in fade-in slide-in-from-bottom-6 duration-1000 relative overflow-hidden">
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between items-center pl-1 pr-1">
                ...
                <a href="/forgot-password" className="text-[11px] font-semibold text-indigo-400 hover:text-indigo-300 transition-colors">
                  Forgot?
                </a>
              </div>
              <input
            ...
            <button
              type="submit"
              className="w-full relative inline-flex items-center justify-center mt-2 px-6 py-3.5 text-sm font-bold text-white transition-all duration-200 bg-indigo-600 rounded-xl hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-600 focus:ring-offset-[#0a0a0a] shadow-[0_0_20px_rgba(79,70,229,0.3)] hover:shadow-[0_0_30px_rgba(79,70,229,0.5)] active:scale-[0.98]"
            >
              Sign In
            </button>
          </form>
          ...
          <div className="my-8 flex items-center justify-center gap-3">
            ...
            <span className="text-xs font-semibold text-zinc-600 uppercase tracking-widest whitespace-nowrap">Or continue with</span>
            <div className="h-px w-full bg-white/5"></div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <button
              ...
              className="flex items-center justify-center gap-2 px-4 py-2.5 bg-white/3 border border-white/5 rounded-xl hover:bg-white/8 transition-colors text-sm font-semibold text-zinc-300"
            >
            ...
            <button onClick={handleGithubLogin} className="flex items-center justify-center gap-2 px-4 py-2.5 bg-white/3 border border-white/5 rounded-xl hover:bg-white/8 transition-colors text-sm font-semibold text-zinc-300">
