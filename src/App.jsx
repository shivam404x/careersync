...
function App() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center gap-4 w-full overflow-x-hidden">
  ...
  return (
    <BrowserRouter>
      {/* RESPONSIVE NAVBAR */}
      <nav className="bg-slate-950 text-white px-4 md:px-10 py-3 md:py-4 shadow-lg sticky top-0 z-50 w-full overflow-x-hidden border-b border-white/5">
        ...
        {isMobileMenuOpen && (
          <div className="lg:hidden mt-4 flex flex-col gap-4 pb-4 border-t border-slate-800 pt-4 px-2 animate-in slide-in-from-top-2 w-full">
      ...
      {/* FIXED CONTAINER: Replaced max-w-[100vw] with w-full to prevent layout shifts */}
